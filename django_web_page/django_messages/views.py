...
@login_required
def inbox(request, template_name='/var/www/html/webdjango/mypage/korisnici/templates/message/inbox.html'):
    """
    ...
    message_list_deleted = Message.objects.trash_for(request.user)
    return render(request, template_name, {
        'message_list': message_list,
        'message_list_deleted': message_list_deleted,
    })

@login_required
def outbox(request, template_name='/var/www/html/webdjango/mypage/korisnici/templates/message/outbox.html'):
    """
...
@login_required
def trash(request, template_name='/var/www/html/webdjango/mypage/korisnici/templates/message/trash.html'):
    """
...
def compose(request, recipient=None, form_class=ComposeForm,
        template_name='/var/www/html/webdjango/mypage/korisnici/templates/message/compose.html', success_url=None,
...
def view(request, message_id, form_class=ComposeForm, quote_helper=format_quote,
        subject_template=_(u"Re: %(subject)s"),
        template_name='/var/www/html/webdjango/mypage/korisnici/templates/message/view.html'):
    """
